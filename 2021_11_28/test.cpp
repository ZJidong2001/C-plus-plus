...
//	int a = 10;
//
//	int& b = a;  // 引用，给变量a起了个别名为b
//
//	int* p = &b;  // 取地址，将b的地址取出来
//
//	return 0;
//}
...
//	r2 = tmp;
//}
//// 他们三个构成函数重载，但是swap(x, y);调用时存在歧义，他不知道调用传值还是传引用
//// 类似以前讲的下面两行代码，他们构成重载，但是存在歧义
//// void f();
//// void f(int x = 0);
//int main()
//{
...
//{
//	SLTNode* plist = NULL;
//	SListPushBack(plist, 1);  // 一级指针的引用
//	SListPushBack(plist, 2);  // 一级指针的引用
//	SListPushBack(&plist, 3);  // 二级指针
//	SListPushBack(&plist, 4);  // 二级指针
//
//	SListPrint(plist);
//
//	return 0;
...
//{
//	static int c = a + b;  // 静态变量或全局变量等不会还给系统
//	return c;
//}
//int main()
//{
...
//
//	int a4 = 10;  // 权限的缩小，可以
//	const int& b4 = a4;  // a2能修改，b2作为其引用不能修改也可以
//
//	return 0;
//}
